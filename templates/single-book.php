                    ...
                    <div class="book__box">
                        ...
                        <?php if ($books_content) : ?>
                            <div class="book__info">
                                <p class="book__author"><span>Autor:</span> <?php echo esc_html( $book_author ); ?></p>
                                <p class="book__date"><span>Data wydania:</span>  <?php echo esc_html( $book_date ); ?></p>
                                <p class="book__genre"><span>Gatunek:</span> <?php echo esc_html( $book_genre ); ?></p>
                            </div>
                        <?php endif; ?>
                        </div>
